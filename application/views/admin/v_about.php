	...
	<section class="content">
		...
		<div class="row justify-content-center">
			<div class="col-lg-7 col-md-3 col-sm-4 text-center">
				...
				<p class="mt-2 mb-2 rounded alert alert-secondary"><i class="fas fa-info-circle"></i> Mengenal Sistem Pendukung Keptusan serta algoritma dari Simple Additive Weighting, berikut penjelasan singkatnya berdasarkan studi kasus <b>Desa di Kabupaten Jember</b>.</p>
			</div>
			<div class="col-lg-12" id="accordion">
				<div class="card card-primary card-outline">
					...
					<div id="collapseZero" class="collapse show" data-parent="#accordion">
						<div class="card-body text-justify">
							...
							untuk memecahkan berbagai persoalan yang tidak terstruktur (Dewanto, 2015).
						</div>
					</div>
				</div>
				<div class="card card-primary card-outline">
				...
				<div class="card card-primary card-outline">
					...
					<div id="collapseSix" class="collapse" data-parent="#accordion">
						<div class="card-body text-justify">
							<ul>
								<li>[1] Dewanto. (2015). Sistem Penunjang Keputusan Investasi Saham dengan Metode SAW di Bursa Efek Jakarta, Skripsi, Teknik Informatika Universitas Esa Unggul, Jakarta</li>
								<li>[2] Sa’id EG., Rachmayanti, dan MZ. Muttaqin. 2004. Manajemen Teknologi Agribisnis. Jakarta: Ghalia Indonesia. </li>
								<li>[3] Djoyohadikusumo (1994). Pengertian Teknologi. Yogyakarta: BPFE.</li>
								<li>[4] Maryatin (2013). Sebuah Paradoksal Krisis Pangan dan Ironi Ketahanan Pangan. Equilibrium, Volume 1 No 1, 93-117.</li>
								<li>[5] Turban. 2001. Decision Support System and intelligent system (Sistem Pendukung Keputusan dan Sistem Cerdas). Yogyakarta, Andi</li>
								<li>[6] Dilahur. (1994). Geografi Desa dan Pengertian Desa. Forum Geografi, 8(14)125.</li>
								<li>[7] Elistri, M., Wahyudi, J., Supardi, R. (2014). Penerapan Metode SAW Dalam Sistem Pendukung Keputusan Pemilihan Jurusan Pada Sekolah Menengah Atas Negeri 8 Seluma. Jurnal Media Infotama, 10(2), 105-109.</li>
								<li>[8] Wibowo, K.M., Kanedi, I., Jumadi, J. (2015). Sistem Informasi Geografis (SIG) Menentukan Lokasi Pertambangan Batu Bara Di Provinsi Bengkulu Berbasi Website. Jurnal Media Infotama, 11(1), 51-60. </li>
							</ul>
						</div>
					</div>
				</div>
